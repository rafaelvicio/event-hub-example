...
})(SystemErrorConditionMapper = exports.SystemErrorConditionMapper || (exports.SystemErrorConditionMapper = {}));
...
function translate(err) {
    ...
    if (rhea_promise_1.isAmqpError(err)) { // translate
        ...
        if (exports.retryableErrors.indexOf(error.name) === -1) { // not found
